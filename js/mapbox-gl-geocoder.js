! function t(e, i, n) {
    ...
    1: [function(t, e, i) {
        ...
        n.prototype = mapboxgl.util.inherit(mapboxgl.Control, {
                ...
                n.type = "text", n.placeholder = this.options.placeholder, n.addEventListener("keydown", r(function(t) {
                    ...
                    if (i) {
                        if (this.options.flyTo)
                            if (i.bbox && i.context && i.context.length <= 3 || i.bbox && !i.context) {
                                var n = i.bbox;
                                t.fitBounds([
                                    [n[0], n[1]],
                                    [n[2], n[3]]
            ...
            _query: function(t) {
                t && ("object" == typeof t && t.length && (t = [mapboxgl.util.wrap(t[0], -180, 180), mapboxgl.util.wrap(t[1], -180, 180)].join()), this._geocode(t, function(t) {
                    if (t.length) {
                        var e = t[0];
            ...
            _setInput: function(t) {
                t && ("object" == typeof t && t.length && (t = [mapboxgl.util.wrap(t[0], -180, 180), mapboxgl.util.wrap(t[1], -180, 180)].join()), this._inputEl.value = t, this._input = null, this._typeahead.selected = null, this._typeahead.clear(), this._change())
            },
            _clear: function() {
    ...
    2: [function(t, e, i) {
        ...
        e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(t) {
            ...
            if (s(i)) switch (arguments.length) {
                ...
                for (r = Array.prototype.slice.call(arguments, 1), u = i.slice(), n = u.length, h = 0; h < n; h++) u[h].apply(this, r);
            return !0
            ...
            if (i = this._events[t], r = i.length, n = -1, i === e || s(i.listener) && i.listener === e) delete this._events[t], this._events.removeListener && this.emit("removeListener", t, e);
            else if (o(i)) {
                for (a = r; a-- > 0;)
    ...
    3: [function(t, e, i) {
        ! function() {
            ...
            "undefined" != typeof i ? e.exports = n : t.fuzzy = n, n.simpleFilter = function(t, e) {
                ...
                for (var p = 0; p < o; p++) n = e[p], l[p] === t[s] ? (n = u + n + c, s += 1, h += 1 + h) : h = 0, a += h, r[r.length] = n;
                return s === t.length ? {
                    rendered: r.join(""),
                    score: a
                } : null
    ...
    4: [function(t, e, i) {
        ...
        function a(t) {
            return "symbol" == typeof t || o(t) && b.call(t) == d
        }
